...
import 'package:game_grid/view/screens/auth/register/complete_profile/favorite_players.dart';
...
class EditFavoriteTeam extends StatefulWidget {
  const EditFavoriteTeam({super.key});

  @override
  State<EditFavoriteTeam> createState() => _EditFavoriteTeamState();
}

class _EditFavoriteTeamState extends State<EditFavoriteTeam> {
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            MyText(
              text:
                  'Please select your favorite team that will help us show you the best data based on your selection.',
