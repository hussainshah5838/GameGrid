...
class FavoriteCasinos extends StatefulWidget {
  const FavoriteCasinos({super.key});

  @override
  State<FavoriteCasinos> createState() => _FavoriteCasinosState();
}

class _FavoriteCasinosState extends State<FavoriteCasinos> {
